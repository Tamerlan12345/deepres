...
class UserLogin(BaseModel):
    username: str = Field(..., max_length=50, description="The user's username")
    password: str = Field(..., max_length=128, description="The user's password")
...
class ReportCreate(BaseModel):
    query: str = Field(..., max_length=5000, description="The report query")

...
if os.path.exists(frontend_dist):
    ...
    async def serve_spa(full_path: str):
        ...
        # Security: Use os.path.commonpath with absolute paths to securely validate boundaries.
        # This prevents bypassing string prefix checks with directories like "dist-secret".
        ...
        try:
            ...
            # Raised if paths are on different drives (e.g. on Windows)
            return FileResponse(os.path.join(frontend_dist, "index.html"))

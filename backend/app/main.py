...
if os.path.exists(frontend_dist):
    ...
    async def serve_spa(full_path: str):
        ...
        try:
            abs_safe_path = os.path.abspath(os.path.join(frontend_dist, full_path))
            ...
            # Catch ValueError from os.path.commonpath when paths are on different drives
            return FileResponse(os.path.join(frontend_dist, "index.html"))

        if os.path.exists(abs_safe_path) and os.path.isfile(abs_safe_path):
            return FileResponse(abs_safe_path)
